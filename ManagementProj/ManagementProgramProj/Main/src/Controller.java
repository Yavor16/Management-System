...
public class Controller  implements Initializable{
    ...
    public void OpenUserScene(ActionEvent e) throws IOException{
        URL url = new File("ManagementProgramProj/Main/src/Scenes/UserScenes/UserScene.fxml").toURI().toURL();
    ...
    public void OpenAdminScene(ActionEvent e) throws IOException {
        URL url = new File("ManagementProgramProj/Main/src/Scenes/AdminScenes/AdminMainScene.fxml").toURI().toURL();
        root = FXMLLoader.load(url);
        stage = (Stage)((Node )e.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
    ...
    void AddImageToBttn(Button bttn, String imageName){
        try {
            URL url = new File("ManagementProgramProj/Main/images/" + imageName + ".png").toURI().toURL();
